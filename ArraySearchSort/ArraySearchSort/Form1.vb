Public Class Form1
    Dim src, n, i, j, k, a(100), flag, len As Integer
    Dim str As String
...
ListBoxInputFor_n:
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click 'SEARCH
        ...
        ListBox2.Items.Add("The value is available at point " & i + 1)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click 'SORT DESCENDING
        'ListBox2.Items.Clear()
        ListBox2.Items.Add("The List Sorted In descending order is : ")
        k = n - 2
        While k >= 0
            For i = 0 To k Step 1
                If a(i) < a(i + 1) Then
                    Swap(Of Integer)(a(i), a(i + 1))
                End If
            Next i
            k = k - 1
        End While
